...
function checkboxHandler(event) {
	let cb = event.target;
	let name = cb.id;	// it is a name, because the entry can span over multiple cells and by that results in groups by name elements
	...
	if(cb.checked) {
		...
		toggleEntryInModule(moduleName, type, name, cb.checked);
	} else {
